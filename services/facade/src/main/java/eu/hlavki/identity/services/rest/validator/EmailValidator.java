package eu.hlavki.identity.services.rest.validator;
 ...
 * <a href="http://www.regular-expressions.info/email.html">article</a> discusses it is not necessarily
 * practical to implement a 100% compliant email validator. This implementation is a trade-off trying to match
 * most email while ignoring for example emails with double quotes or comments.
 *
